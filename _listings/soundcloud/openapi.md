...
paths:
  ...
  /groups/{group_id}/contributors.json:
    get:
      ...
      x-api-path-slug: groupsgroup-idcontributorsjson-get
      parameters:
      - in: query
        name: consumer_key
      responses:
  ...
  /groups/{group_id}/tracks.json:
    get:
      ...
      x-api-path-slug: groupsgroup-idtracksjson-get
      parameters:
      - in: query
        name: consumer_key
      responses:
  ...
  /comments/{comment_id}.json:
    get:
      ...
      x-api-path-slug: commentscomment-idjson-get
      parameters:
      - in: query
        name: consumer_key
      responses:
  ...
  /resolve.json:
    get:
      ...
      x-api-path-slug: resolvejson-get
      parameters:
      - in: query
        name: consumer_key
      responses:
